...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="http://localhost/mcaproject/departmentleave/faculty/m11.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-user-circle" style="font-size:24px;color:black"></i>  Faculty Login</a> 
    <a href="http://localhost/mcaproject/departmentleave/student/m111.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user-circle" style="font-size:24px"></i> Student  Login</a> 
      <a href="http://localhost/mcaproject/departmentleave/main2.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user-circle" style="font-size:24px"></i> HOD  Login</a>
</div>
