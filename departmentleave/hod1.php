...
<li>  <a href="http://localhost/mcaproject\departmentleave\status/allleaves.php" class="notification"><span style="padding-left: 58em; color: white;"><i class="material-icons">&#xe003;</i></span>
  <span class="badge"><!-- <?php  $result = mysqli_query($connect, $query);
   $row = mysqli_num_rows($result);  
        printf("Number of row in the table : " . $row);?> --></span>
</a></li>
</ul>
