var app = angular.module("myModule", [])
				.controller("myController", function($scope, $http, $timeout){
					...
					$scope.insertData = function(){
						$http.post("insert.php", {firstname: $scope.firstname, lastname: $scope.lastname, status: $scope.status})
						.then(function(){
					...
					$scope.updateData = function(mem_id){
						...
						$scope.btnInsert = true;
						$http.post("update.php", {mem_id: $scope.mem_id, firstname: $scope.firstname, lastname: $scope.lastname, status: $scope.status})
					...
					$scope.updateBtn = function(mem_id, firstname, lastname, status){
