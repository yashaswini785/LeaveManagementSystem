...
<div class="w3-sidebar w3-bar-block w3-light-grey w3-card" style="width:300px;">
 ...
 <i class="fa fa-user-circle"style="color:grey;"></i>   <b>  Faculty </b>   <i class="fa fa-caret-right"></i></div>
  <div id="demoAcc" class="w3-hide w3-white w3-card-4">
    <a href="http://localhost/hod/addfaculty.php" class="w3-bar-item w3-button">Add Faculty</a>
    <a href="http://localhost/hod/managefaculty.php" class="w3-bar-item w3-button">Manage Faculty</a>
  </div>
 <!--  <div class="w3-bar-item w3-button" onclick="myAccFunc1()">
 <i class="fa fa-calendar"  style="color:grey;"></i>   <b>  Leave Type </b> <i class="fa fa-caret-right"></i></div>
  <div id="demoAcc1" class="w3-hide w3-white w3-card-4">
    <a href="#" class="w3-bar-item w3-button">Add LeaveType</a>
    <a href="#" class="w3-bar-item w3-button">Manage LeaveType</a>
  </div> -->

 <div class="w3-bar-item w3-button" onclick="myAccFunc2()">
 <i class="fa fa-laptop" style="color:grey;"></i>    <b>Leave Management </b> <i class="fa fa-caret-right"></i></div>
  <div id="demoAcc2" class="w3-hide w3-white w3-card-4">
    <a href="http://localhost/hod/leaves/allleaves.php" class="w3-bar-item w3-button">All Leaves</a>
    <a href="http://localhost/mcaproject\departmentleave\status/allleaves.php" class="w3-bar-item w3-button">Pendening Leaves</a>
    <a href="http://localhost/mcaproject\departmentleave\approved/allleaves.php" class="w3-bar-item w3-button">Approved Leaves</a>
    <a href="http://localhost/mcaproject\departmentleave\notapproved/allleaves.php" class="w3-bar-item w3-button">NotAppoved Leaves</a>
  </div>
...
<center>welcome</center>
  ...
  <div class = "col-md-6 well">
    <h3 class = "text-primary">View  All Leaves </h3>
    <hr style = "border-top:1px dotted #ccc;">
    <form>
       <div class = "form-inline">
       <!--  <label ng-show = "btnInsert">Subject</label><br/>
        <input type = "text" class = "form-control" ng-model = "firstname" id = "firstname" ng-show = "btnInsert"/><br/>
        <label ng-show = "btnInsert">Description</label><br/>
        <textarea  rows="2" columns="3" class = "form-control" ng-model = "lastname" id = "lastname" ng-show = "btnInsert"></textarea><br/> -->
          <label>
    ...
    <table class = "table table-responsive table-bordered alert-warning">
      ...
      <tbody>
        <tr ng-repeat = "member in members">
          ...
          <td>{{member.status}}
          <td><center><button type = "button" ng-click = "updateBtn(member.mem_id, member.firstname, member.lastname, member.status)" class = "btn btn-warning">Take action</button> <button type = "button" ng-click = "deleteData(member.mem_id);" class = "btn btn-danger"><span class = "glyphicon glyphicon-remove"></span></button></center></td>
        </tr>
      </tbody>
    </table>
